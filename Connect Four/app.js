document.addEventListener('DOMContentLoaded', () => {
    ...
    for(var i = 0, len = squares.length; i < len; i++)
        (function(index){
            //adding onclick on each square in grid
            squares[i].onclick = function(){
                ...
                if(squares[index + 7].classList.contains('taken')){
                    ...
                    //if the square below my current square is not taken, you can't go there
        ...
        function checkBoard(){
            ...
            // now taking 4 values in each winningArrays and plug them into squares
            for(let y = 0; y < winningArrays.length; y++){
                ...
                //now same process for player-two
